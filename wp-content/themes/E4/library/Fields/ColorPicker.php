...
class ColorPicker implements Field{
    ...
    static function loadScripts()
    {
        if(is_admin()) {
            ...
            wp_enqueue_script( 'wp-color-picker-script-handle', get_template_directory_uri() . '/library/Assets/Js/custom-posts-color-picker.js', array( 'wp-color-picker' ), false, true );
        }
    }
